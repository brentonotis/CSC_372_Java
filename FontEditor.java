...
// Frame that displays text and allows user to modify font/size
...
public class FontEditor extends JFrame {
	...
	public FontEditor() {
		...
		// Listener shared amongst all components
	...
	// Creates combo box with font style choices
	// @return panel containing the combo box
	...
	// Create check boxes for selecting bold and italic styles
	// @return panel containing check boxes
	...
	// Create radio buttons to select font size
	// @return panel containing radio buttons
	...
	// Gets user choices for font options and sets font per selections
	...
	public static void main(String[] args) {
		JFrame frame = new FontEditor();
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frame.setTitle("Font Editor");

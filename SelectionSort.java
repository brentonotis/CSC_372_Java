...
/**
 * Class using selection sort to return array list of names in reversed alphabetical order
...
public class SelectionSort {
	...
	public static void main (String[] args) {
		...
		sort(userNames);
		System.out.println("Sorted array of names: " + userNames);
	}
	...
	/**
	 * Sorts array list via selection sort algorithm 
